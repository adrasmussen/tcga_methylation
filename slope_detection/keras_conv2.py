...
#
# This trains the neural net to learn the total window length
#
...
model = keras.Model(inputs=inputlayer, outputs=dense3)
...
history = model.fit(train_x, train_y, batch_size=80, epochs=20, validation_split=0.2)
...
plt.plot(np.linspace(0,2048,2048), train_x[0])
print(model.predict(a))


model.save('windows_conv_2048to256_2.knn')